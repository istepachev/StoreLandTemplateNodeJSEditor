...
function catalogFunctions() {
  ...
  var // Минимальное значение цены для фильтра
    priceFilterMinAvailable = parseInt(
      $(".goodsFilterPriceRangePointers .min").text()
    ),
    // Максимальное значение цены для фильтра
    priceFilterMaxAvailable = parseInt(
      $(".goodsFilterPriceRangePointers .max").text()
    ),
    // Максимальное значение цены для фильтра
      ...
      $.fancybox({
        ...
        beforeShow: function () {
          ...
          if (productShopContent) {
            ...
            $(".fancybox-inner .product-view .product-shop").addClass(
              "col-lg-5 col-md-6"
            );
          } else {
            $(".fancybox-inner .product-view .product-order").addClass(
    ...
    if (1 == document.quickviewPreload[href]) {
      ...
      $.fancybox({
        ...
        beforeShow: function () {
          ...
          $(".fancybox-inner .product-view .product-shop").removeClass(
            "col-lg-5 col-md-6"
          );
...
function goodsImage() {
  ...
  $(function () {
    ...
    owl.on("initialized.owl.carousel changed.owl.carousel", function (event) {
      ...
      if (items > size) {
        $(
          ".thumblist-box.navigation .prev, .thumblist-box.navigation .next"
        ).show();
      } else {
        $(
          ".thumblist-box.navigation .prev, .thumblist-box.navigation .next"
...
function validPhone() {
  ...
  if (check == true && check != "") {
    ...
    $input.addClass("input--error");
    $input.after(
      '<div class="phone-error">Вы ввели неверный номер телефона</div>'
    );
...
function validEmailF() {
  ...
  var email = $input.val();
  var check = /^([a-z0-9_\.-])+@[a-z0-9-]+\.([a-z]{2,4}\.)?[a-z]{2,4}$/i.test(
    email
  );
  ...
  $("#promo-block .pdt-sale .products-grid").owlCarousel({
    ...
    onInitialized: function () {
      ...
      $oldPrices.each(function (i, item) {
        ...
        var nowPrice = Math.ceil(
          $(item).next('.price[itemprop="price"]').attr("content")
        );
